...
<div class="portlet-body" id="chats">
                                        ...
                                        <ul class="chats">
                                            ...
                                            <li class="<?php if(!empty($row->hs_sender_id)){?>in<?php }?><?php if(!empty($row->hs_receiver_id)){?>out<?php }?>">
                                                ...
                                                <div class="message">
													...
													<?php if(!empty($row->hs_sender_id)){?>By Passenger<?php }?>
                                    ...
                                    <div class="chat-form">
                                        ...
                                        <div class="btn-cont">
                                            <span class="arrow"> </span>
                                            <a  class="btn blue icn-only" onclick="insert_passenger_helpdesk_support()">
 ...
 <script>	
function insert_passenger_helpdesk_support()
{
	var message = $('#message').val();
	var passenger_id= <?php echo $passenger_id;?>;
	if(message!=''){
		 $.ajax({
			url: '<?php echo base_url();?>index.php/Passenger_management/insert_passenger_helpdesk_support',
			type: 'post',
			data: {passenger_id : passenger_id, message : message},
			success: function()
			{
