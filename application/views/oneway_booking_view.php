                ...
                <div class="page-content">
                 ...
                 <div class="row">
                    ...
                    <div class="table-toolbar">
                  	 ...
                  	 <?php if($oneway_data->b_status < 4){?>

				  <?php if($oneway_data->b_status != 0){?>
                    ...
                    <?php if($oneway_data->b_status < 5 ){?>
                        ...
                        <div class="btn-group">
                           ...
                           <?php if($oneway_data->b_status ==4 ){?>Change Cab<?php } else { ?>Assign Cab<?php } ?>
						...
						<?php if( $oneway_data->b_rent_card_status == 0){?>
...
<button type="submit" id="sample_editable_1_new" name="view_id" value="<?php echo $oneway_data->id;?>" class="btn btn yellow-haze" >
						  ...
						  <?php if($oneway_data->b_status ==4 && $oneway_data->b_rent_card_id !=0 && $oneway_data->b_rent_card_status == 1){?>
						...
						<?php }?>
						  ...
						  <?php if($oneway_data->b_status >=5 && $generate_invoice['balance'] > 0){?>
...
<button type="submit"  id="sample_editable_1_new" formaction="<?php echo base_url(); ?>index.php/Invoice_view/outstation_invoice" value="<?php echo $generate_invoice['id']; ?>" name="ticket_id" class="btn blue-chambray">
 ...
 <hr>
				   ...
				   <table class="table table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr >
                                 ...
                                 <td><?php echo $oneway_data->b_id;?></td>

                                 <td><?php echo date('d/m/Y h:i A',strtotime($oneway_data->b_booking_date_time));?></td>

                                 <td><?php echo date('d/m/Y',strtotime($oneway_data->b_from_date))." ".date('h:i A',strtotime($oneway_data->b_from_time));?></td>

                                 <td><?php echo $this->db->get_where('city_detail',array('id'=>$oneway_data->b_from_city))->row()->c_name; ?></td>

                                 <td><?php echo $oneway_data->b_pickup_point;?></td>

                                 <td><?php echo $oneway_data->b_drop_point;?></td>

                                <td>

								<?php if($oneway_data->b_status == 0){echo "<span class='label label-sm label-danger'>Cancelled</span>";} if($oneway_data->b_status == 1){echo "<span class='label label-sm label-info'> pending </span>";} if($oneway_data->b_status == 2){echo "<span class='label label-sm label-primary'>Owner Assigned </span>";}  if($oneway_data->b_status == 3){echo " <span class='label label-sm label-default'> Driver Assigned </span>";} if($oneway_data->b_status == 4){ if($oneway_data->b_rent_card_id !=0 && $oneway_data->b_rent_card_status == 1){ echo "<span class='label label-sm label-default'> Duty Slip Generated </span>"; } else { echo "<span class='label label-sm label-warning'> Cab Assigned </span>"; } } if($oneway_data->b_status == 5){ if( $generate_invoice['balance'] > 0 ){echo "<span class='label label-sm label-info'> Complete Trip</span>";}else{ echo "<span class='label label-sm label-info'> Due  </span>"; }  } if($oneway_data->b_status == 6){ if( $generate_invoice['balance'] > 0 ){echo "<span class='label label-sm label-info'> Due </span>";}else{echo "<span class='label label-sm label-success'> Trip Finished</span>"; } }?>
                              ...
                              <tr>
								...
								<!-- <?php //if($oneway_data->b_ac_non_ac == 1) { ?>AC<?php //} else {?>NON-AC <?php //} ?> -->
                                 <td><?php echo $this->db->get_where('vehicle_category_detail',array('id'=>$oneway_data->b_vc_id))->row()->category_name; ?> </td>

                                  

								  <td>RS. <?php echo $oneway_data->b_pk_rate;?></td>

                                 <td>Rs. <?php echo $oneway_data->b_pk_rate_per_km;?></td>

                                 <td>Rs. <?php echo $oneway_data->b_pk_rate_per_hour;?></td>

                                 <td><?php echo $oneway_data->b_pk_min_km; ?></td>

                                <td><?php echo $oneway_data->b_pk_min_hour; ?></td>
								
								<td><?php echo $oneway_data->b_remarks; ?></td>
                            ...
                            <thead>
                              ...
                              <tr>
                                 ...
                                 <td colspan="2"><?php echo $oneway_data->b_p_name; ?></td>

                                 <td><?php echo $oneway_data->b_p_contact; ?></td>                              

                                 <td><?php echo $this->db->get_where('payment_type',array('id'=>$oneway_data->b_payment_type))->row()->payment_name;?></td>

                                 <td  colspan="3">Package ID : <?php echo $oneway_data->b_package_id; ?> , 

								 <?php echo $oneway_data->package_type." ".$oneway_data->package_sub_type;?> , 

								

								 Vahicle Category : <?php echo $oneway_data->category_name;?> , 

								 City : <?php echo $oneway_data->c_name;?>
                              ...
                              <tr>
								  ...
								  <?php if($oneway_data->b_updated_by!=0){ echo $this->db->get_where('user_detail',array('id'=>$oneway_data->b_updated_by))->row()->u_full_name." - "; echo date('d/m/Y h:i A',strtotime($oneway_data->b_updated_date_time)); } else { echo "N/A";   } ?></td>								                                 

								  <td colspan="2" ><?php if($oneway_data->b_cancelled_by!=0){ echo $this->db->get_where('user_detail',array('id'=>$oneway_data->b_cancelled_by))->row()->u_full_name." - ";  echo date('d/m/Y h:i A',strtotime($oneway_data->b_cancel_date_time)); } else { echo "N/A"; }?></td>

								                                

                                 <td colspan="2"><?php if($oneway_data->b_cancelled_by!=0){ if($oneway_data->b_cancel_type==1){echo "Customer";} if($oneway_data->b_cancel_type==2){echo "Agent";}  if($oneway_data->b_cancel_type==3){echo "Rashmi Cabs";}}else { echo "N/A"; }?></td	>   

								  

								  <td colspan="2"><?php if($oneway_data->b_cancelled_by!=0){echo $oneway_data->b_cancel_note;}else { echo "N/A"; }?></td	>                               
							  ...
							  <?php if($oneway_data->b_status!=1) {?>

							  <?php if($oneway_data->b_status!=0 || $oneway_data->b_status==4) {?>
                              ...
                              <tr>
										 ...
										 <td colspan="1"><?php echo $this->db->get_where('agent_detail',array('id'=>$oneway_data->b_agent_id))->row()->a_full_name;?></td>

										 

										 <td colspan="2"><?php if(!empty($oneway_data->b_vc_category_id)){ echo $this->db->get_where('vehicle_category_detail',array('id'=>$oneway_data->b_vc_category_id))->row()->category_name; }?><br /><?php if(!empty($oneway_data->b_vehicle_id)){ echo $this->db->get_where('vehicle_detail',array('id'=>$oneway_data->b_vehicle_id))->row()->v_name;}?></td>

										 

										 <td><?php echo $oneway_data->b_driver_name; ?></td>

										 

										 <td><?php echo $oneway_data->b_driver_contact; ?></td> 

										 

										 <td><?php echo $oneway_data->b_vehicle_number; ?></td>

										  

										 <td colspan="1"><?php if($oneway_data->b_cab_assign_type==1){echo "By Agent - ".$this->db->get_where('agent_detail',array('id'=>$oneway_data->b_cab_assign_by))->row()->a_full_name." - ";}else{echo $this->db->get_where('user_detail',array('id'=>$oneway_data->b_cab_assign_by))->row()->u_full_name." - ";} ?><?php echo date('d/m/Y h:i A',strtotime($oneway_data->b_assign_date_time)); ?></td>

                              </tr>							  

							  <?php } }?>

							  <?php if($oneway_data->b_complain_msg!=''){?>
                              ...
                              <tr>
                                  ...
                                  <td colspan="4"><?php if($oneway_data->b_complain_msg!=''){ echo $oneway_data->b_complain_msg; } else { echo "N/A";   } ?></td>                               

								  <td colspan="2" ><?php if($oneway_data->b_complain_datetime!='0000-00-00 00:00:00'){ echo date('d/m/Y h:i A',strtotime($oneway_data->b_complain_datetime)); } else { echo "N/A"; }?></td>

								                                

                                  <td colspan="2"><?php if($oneway_data->b_complain_read_datetime!='0000-00-00 00:00:00'){ echo date('d/m/Y h:i A',strtotime($oneway_data->b_complain_read_datetime)); } else { echo "N/A"; }?></td	>   
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title"><strong>Oneway Booking Edit</strong></h4>
					...
					<div class="modal-body">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="name" name="b_p_name" value="<?php echo $oneway_data->b_p_name;?>" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="mobile" name="b_p_contact" value="<?php echo $oneway_data->b_p_contact;?>"  >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="pickup" name="b_pickup_point" value="<?php echo $oneway_data->b_pickup_point;?>" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="drop" name="b_drop_point" value="<?php echo $oneway_data->b_drop_point;?>">
							...
							<div class="row">
													...
													* </span>
													...
													<div>
														...
														<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
															...
															<input type="text"  name="b_from_date" id="b_from_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($oneway_data->b_from_date));?>" readonly >
								...
								<?php if($oneway_data->b_type == 2){?><div class="form-group col-md-4">
													...
													* </span>
													...
													<div>
														...
														<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
															...
															<input type="text"  name="b_to_date" id="b_to_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($oneway_data->b_to_date));?>" readonly >
								...
								<div class="form-group col-md-4">
									...
									<input type="text" id="time" name="b_from_time" class="form-control timepicker timepicker-no-seconds" style="width: 200px" value="<?php echo $oneway_data->b_from_time;?>" required>

									<input type="hidden" id="Editid" value="<?php echo $oneway_data->id?>">
								...
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<input type="hidden" name="id" value="<?php echo $oneway_data->id;?>"  />
									   ...
									   <!--/span-->
                                        ...
                                        <!-- <div class="col-md-6">
                                             ...
                                             <input class="form-control form-control  date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php //echo date('d-m-Y',strtotime($oneway_data->b_booking_date_time));?>"   size="16" type="text"  name="cancel_date" id="cancel_date"  />
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn red-haze" onclick="cancel(<?php echo $oneway_data->id;?>)" >Cancel Booking</button>
	...
	<?php 
		...
		$data =$this->db->get_where('package_detail',array('p_sub_type'=>$oneway_data->b_type,'p_from_city'=>$oneway_data->b_from_city))->result();

		

		$total_distance_km = $oneway_data->b_estimated_distance;
...

		{
			...
			$max_seats = $this->db->select_max('v_seat_number')->get_where('vehicle_detail',array('v_category_id'=>$d->p_v_category))->row();
				...
				$date = new DateTime($oneway_data->b_from_time);
...

				{
					...
					$oneway_data->b_to_date = $oneway_data->b_from_date;										
				...
				if( ($d->p_min_km * $total_days ) > $total_distance_km)

					{
					 ...
					 $km_rate = $chargeable_km * $d->p_extra_km_rate;
		...
		<tr class="odd gradeX" >
			...
			<td ><?php if($d->id != $oneway_data->b_pk_id){?> <a href="javascript:;" class='btn yellow' onclick="book_package(<?php echo $d->id ?>,<?php echo $total_estimated_rate; ?>)" ><i class="fa fa-cab"></i></a><?php } ?></td>
								...
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<input type="hidden" name="id" id="id" value="<?php echo $oneway_data->id;?>"  />
                                          ...
                                          <div class="form-group">
										   ...
										   <div class="col-md-4">
                                             ...
                                             <label class="control-label">Select Agent<span class="required">*</span></label>
											  ...
											  <select class="form-control select2" name="agent_name" id="agent_id" data-placeholder="Choose a Category" tabindex="1" required disabled>

											  							<option></option>

                                                                       <?php foreach($agent_data as $ad){?>

																	   <option value="<?php echo $ad->id; ?>" <?php if($oneway_data->b_type == 1){  if($ad->id == $oneway_data->b_agent_id ){echo "selected"; } else{ echo "disabled"; } }else{?><?php if($ad->id==$oneway_data->b_agent_id){?> selected="selected" <?php } }?>><?php echo $ad->a_full_name." - ".$ad->a_city; ?></option>
										   ...
										   <div class="col-md-4">
                                             ...
                                             <label class="control-label">Select Vehicle Category<span class="required">*</span></label>
											  ...
											  <select class="form-control select2" name="cat_name" id="cat_id" data-placeholder="Choose a Category" tabindex="1" required>
																	   ...
																	   <!--<option value="<?php //echo $vc->id; ?>" <?php //if($oneway_data->b_type == 1){  if($vc->id == $oneway_data->b_vc_id ){echo "selected"; } else{ echo "disabled"; } }?> ><?php //echo $vc->category_name; ?></option> -->
										   ...
										   <div class="col-md-4">
                                             ...
                                             <label class="control-label">Select Vehicle<span class="required">*</span></label>
											  ...
											  <select class="form-control select2" name="vehicle_name" id="vehicle_id" data-placeholder="Choose a Category" tabindex="1" required>
                                                                       ...
                                                                       <!--<option value="<?php //echo $oneway_data->b_vehicle_id; ?>" <?php //if($oneway_data->b_type == 1){  echo "selected "; }?> ><?php //echo $this->db->get_where('vehicle_detail',array('id'=>$oneway_data->b_vehicle_id))->row()->v_name; ?></option> -->
		...
		<div class="modal fade bs-modal-lg" id="duty_slip" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<input type="hidden" name="view_id" id="view_id" value="<?php echo $oneway_data->id; ?>"/>			 
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4">
										  ...
										  <?php ?>
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $oneway_data->b_vehicle_number;?> - <?php echo $this->db->get_where('vehicle_detail',array('id'=>$oneway_data->b_vehicle_id))->row()->v_name;?>" disabled  >
                                       ...
                                       <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $this->db->get_where('agent_detail',array('id'=>$oneway_data->b_agent_id))->row()->a_full_name;?>" disabled placeholder="used Owner Name" >
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $oneway_data->b_driver_name;?>" disabled >
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php if($oneway_data->b_self_travel_status == 1){ echo $oneway_data->b_p_name; } else { echo $oneway_data->b_p_name." / ".$passanger_data->p_full_name; }?>" disabled >
									   ...
									   <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" id="firstName" class="form-control" value="<?php if($oneway_data->b_self_travel_status == 1){ echo $oneway_data->b_p_contact; } else { echo $oneway_data->b_p_contact." / ".$passanger_data->p_contact; }?>" disabled >
                                       ...
                                       <!--/span-->
									     ...
									     <div class="row">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" id="firstName" class="form-control" value="<?php echo $oneway_data->package_type." ".$oneway_data->package_sub_type;?>" disabled >
									   ...
									   <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" id="firstName" class="form-control" value="<?php echo $oneway_data->c_name; ?> - <?php echo $this->db->get_where('city_detail',array('id'=>$oneway_data->b_to_city))->row()->c_name; ?>" disabled>
									   ...
									   <div class="col-md-6">
                                          ...
                                          <input class="form-control " size="16" type="text" name="start_date"  onfocus="check_time()" id="start_date" value="<?php echo date('d-m-Y',strtotime($oneway_data->b_from_date));?>" readonly/>
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <input class="form-control form-control  date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php echo date('d-m-Y',strtotime($oneway_data->b_from_date));?>"  size="16" type="text"  name="return_date" id="return_date" onfocus="check_time()" />
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" class="form-control " name="start_time" id="start_time" value="<?php echo date('h:i A',strtotime($oneway_data->b_from_time));?>" readonly >
								...
								<div class="row">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="service_code" class="form-control" readonly placeholder="used service code" value="<?php echo $oneway_data->b_package_id; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="firstName" class="form-control" readonly placeholder="used service name" value="<?php echo $oneway_data->package_type." - ".$oneway_data->package_sub_type;?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="base_price" class="form-control" readonly value="<?php  echo $oneway_data->b_pk_rate; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="min_km" class="form-control" readonly value="<?php  echo $oneway_data->b_pk_min_km; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="min_hr" class="form-control" readonly value="<?php  echo $oneway_data->b_pk_min_hour; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="trip_start_date" class="form-control" readonly value="<?php  echo date('d/m/Y h:i A',strtotime($oneway_data->b_from_date." ".$oneway_data->b_from_time)); ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="advance_pay" class="form-control" readonly value="<?php  echo $oneway_data->b_advance; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="driver_invoice" class="form-control" value="<?php  echo $oneway_data->b_pk_driver_allowance; ?>" readonly>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="exatra_hr_invoice" class="form-control" value="<?php echo $total_trip_hours;?>" readonly>
									...
									<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="night_charge" class="form-control" value="<?php if($oneway_data->b_night_charge_status==1) {echo $oneway_data->b_pk_night_charge;}else {echo "0";} ?>" readonly>
                                    ...
                                    <div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="drop_night_charge" class="form-control" value="<?php if($oneway_data->b_drop_night_charge_status==1) {echo $oneway_data->b_drop_night_charge;}else {echo "0";} ?>" readonly>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<label class="control-label">Discount</label>&nbsp;<span class="badge badge-success"><?php if($oneway_data->b_pk_discount_type==0){

													echo $oneway_data->b_pk_discount."%";
...
<?php
											...
											if($oneway_data->b_pk_discount_type==0){
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn green" onClick="update_invoice(<?php echo $oneway_data->id; ?>)">Complete Trip</button>
							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										...
										<label class="control-label">Minimum Km<span class="required">*</span></label>
										<!--<input type="text" id="firstName" class="form-control" readonly value="<?php  //echo $generate_invoice['min_km'] * $tot_days;?>">-->



										<input type="text" id="firstName" class="form-control" readonly value="<?php  echo $generate_invoice['min_km'];?>">
...
<?php echo $generate_invoice['discount'];	?>"  readonly="readonly">
							...
							<div class="col-md-4">
									...
									<div class="form-group ">
										...
										$c=$this->db->get_where('city_detail',array('id'=>$oneway_data->b_from_city))->row();

										echo $c->c_name;

								

										if($oneway_data->b_type == '2')

										{

										$to_city = $this->db->get_where('city_detail',array('id'=>$oneway_data->b_to_city))->row();
										...
										{
										if($oneway_data->b_type == '1')
											echo " - ".$this->db->get_where('city_detail',array('id'=>$oneway_data->b_to_city))->row()->c_name;
										else
											echo " - ".$oneway_data->b_to_city;
...
<?php $tax_value = explode(',',$generate_invoice['tax_value']);
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-success" onClick="invoice_generate(<?php echo $oneway_data->id;?>)">Generate Invoice</button>
	...
	$('#cat_id').on('change', function()			  

	 {
		...
		{   
			...
			url: "<?php echo base_url();?>index.php/Oneway_view/get_city_by_state", 
...
function get_vehicle_category_data(){
		...
		var vehicle_id = '<?php echo $oneway_data->b_vehicle_id; ?>';
...
function get_vehicle_data(){
	...
	var cat_id = '<?php echo $oneway_data->b_vc_category_id; ?>';
...
function get_driver_data(){
	...
	var assign_driver_id = <?php echo $oneway_data->b_assign_driver_id; ?>;
...

{
					...
					$.ajax({
						...
						url: '<?php echo base_url(); ?>index.php/Ajax_common/update_invoice_offer',
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url(); ?>index.php/Oneway_view/generate_invoice',
...

{
	...
	var valid_from = "<?php echo $oneway_data->b_oo_valid_from_time; ?>";

	var valid_to = "<?php echo $oneway_data->b_oo_valid_to_time; ?>";

	var b_type = <?php echo $oneway_data->b_type; ?>;
	...
	//alert(valid_from + "        "+valid_to);

	if(b_type == 1)

	{

		var to_date="<?php echo $oneway_data->b_to_date; ?>";

		if((valid_from < time) && (valid_to > time) )
	...
	$.ajax({
		...
		url: '<?php echo base_url()."index.php/Oneway_view/update_booking"; ?>',
...
{	
	...
	//	alert(id+"    "+cancel_type+"    "+cancel_time+"  "+cancel_date);
		...
		url: '<?php echo base_url(); ?>index.php/Oneway_view/cancel_booking',
		...
		data: {id:id,cancel_time:cancel_time,cancel_date:cancel_date,cancel_type:cancel_type,cancel_note:cancel_note},
...

			{
						...
						var form = $('<form action="<?php echo base_url(); ?>index.php/Oneway_view" method="post">' +

				  '<input type="hidden" name="oneway_view_id" value="' + id + '"></input>' + '</form>');
...

{
	...
	var booking_id = <?php echo $oneway_data->id;?>;

		

		$.ajax({

		url: '<?php echo base_url(); ?>index.php/Oneway_view/modify_booking_package',
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url(); ?>index.php/Oneway_view/assign_cab',
...
var view_id= <?php echo $oneway_data->id?>;

$('#return_time').val('');

$.ajax({

	url: '<?php echo base_url(); ?>index.php/Oneway_view/fetch_rent_card',
