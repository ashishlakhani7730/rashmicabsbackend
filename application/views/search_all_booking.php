            ...
            <div class="container-fluid">
                ...
                <div class="page-content">
                    ...
                    <div class="breadcrumbs">
                        ...
                        <h1>Search All Booking Reports</h1>
					...
					<div class="row">
						...
						<div class="alert alert-danger">
							<strong>Field Is Required :</strong> <?php echo  $error; ?>
						</div>
						<?php } ?>
                         	...
                         	<div class="portlet light bordered">
                            	...
                            	<div class="portlet-body form">
                                	...
                                	<form action="<?php echo base_url();?>index.php/Report_management/BookingReportsOfSearch" id="subscribeForm" method="post" class="horizontal-form">
											...
											<div class="row">
												...
												<div class="col-md-5">
                                                	...
                                                	<div class="form-group">
														...
														<label class="control-label">Booking Number</label><span class="required">*</span>

														<input class="form-control form-control-inline" type="text" id="bookingno" name="bookingno" value="" />  
												...
												<div class="col-md-2 text-center">
													<label class="control-label"></label><span class="required"></span>
													<div>OR</div>
												</div>
												...
												<div class="col-md-5">
                                                	...
                                                	<div class="form-group">
														...
														<input class="form-control form-control-inline" type="text" id="cstno" name="cstno" value=""/>  
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                   ...
                                   <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_1">
                                        ...
                                        <?php if(!empty($booking_list)) { foreach($booking_list as $pb) { ?>
