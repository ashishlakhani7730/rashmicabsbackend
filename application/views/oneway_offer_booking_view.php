 ...
 <hr>
				  ...
				  <div class="row">
				   <table class="table table-bordered">
                           <thead>
                              <tr >
                                 <th colspan="5" class="blue_row">Booking Details</th>
								  ...
								  <form method="post">
								   <button type="submit"  value="<?php echo $passanger_data->id;?>" name="btn_p_view" formaction="<?php echo base_url().'index.php/Passenger_management/view_passenger'?>" class="btn yellow-saffron">Passenger Details <i class="fa fa-user"></i>
								   </button>
								   </form>
								   </th>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td colspan="2"><?php echo $passanger_data->p_full_name;?></td>
                                 <td><?php echo $passanger_data->p_email_id;?></td>
                                 <td><?php echo $passanger_data->p_id;?></td>
                                 <td colspan="1"><?php echo $passanger_data->p_contact;?></td>
                                 <td colspan="1"><?php echo $passanger_data->p_contact_2;?></td>
                                 <td colspan="1" > <img src="<?php echo base_url();?>uploads/passenger_profile/<?php echo $passanger_data->p_profile;?>" width="75px" height="75px"></td>
                              ...
                              <tr >
                                ...
                                <td><?php if($oneway_data->b_status == 0){echo "<span class='label label-sm label-danger'>Cancelled</span>";} if($oneway_data->b_status == 1){echo "<span class='label label-sm label-info'> pending </span>";} if($oneway_data->b_status == 2){echo "<span class='label label-sm label-primary'>Owner Assigned </span>";}  if($oneway_data->b_status == 3){echo " <span class='label label-sm label-default'> Driver Assigned </span>";} if($oneway_data->b_status == 4){echo "<span class='label label-sm label-warning'> Cab Assigned </span>";} if($oneway_data->b_status == 5){echo "<span class='label label-sm label-info'> Complete Trip</span>";} if($oneway_data->b_status == 6){echo "<span class='label label-sm label-success'> Trip Fininshed</span>";}?></td>
                              </tr>
                              <tr class="red_row">
                              ...
                              <tr>
                                 ...
                                 <td><?php echo $this->db->get_where('vehicle_category_detail',array('id'=>$oneway_data->b_vc_id))->row()->category_name; ?></td>
                                  <td><?php echo $this->db->get_where('vehicle_detail',array('v_category_id'=>$oneway_data->b_vc_id))->row()->v_name; ?></td>
                            ...
                            <thead>
                              ...
                              <tr>
								  ...
								  <td colspan="3" ><?php if($oneway_data->b_cancelled_by!=0){ echo $this->db->get_where('user_detail',array('id'=>$oneway_data->b_cancelled_by))->row()->u_full_name." - ";  echo date('d/m/Y h:i A',strtotime($oneway_data->b_cancel_date_time)); } else { echo "N/A"; }?></td>
								                                
                                  <td colspan="2">Cancel Type</td	>                           
							  ...
							  <tr class="blue_row">
							   <th colspan="7" >Cab Assignning Details</th>
							   </tr>
							  <tr class="red_row">
                              ...
                              <tr>
										 ...
										 <td colspan="2"><?php echo $this->db->get_where('vehicle_category_detail',array('id'=>$oneway_data->b_vc_category_id))->row()->category_name;?><br /><?php echo $this->db->get_where('vehicle_detail',array('id'=>$oneway_data->b_vehicle_id))->row()->v_name;?></td>
										 ...
										 <td colspan="1"><?php echo $this->db->get_where('user_detail',array('id'=>$oneway_data->b_cab_assign_by))->row()->u_full_name." - "; ?><?php echo date('d/m/Y h:i A',strtotime($oneway_data->b_assign_date_time)); ?></td>
                              </tr>							  
							  <?php } }?>
                           </thead>
									...
									<div class="modal-content">
                                       ...
                                       <!--/span-->
                                         <div class="col-md-6">
                                             ...
                                             <input class="form-control form-control  date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php echo date('d-m-Y',strtotime($oneway_data->b_booking_date_time));?>"   size="16" type="text"  name="cancel_date" id="cancel_date"  required/>
                                          </div>
                                       </div>
	...
	<?php 
		...
		<tr class="odd gradeX" >
			...
			<td ><?php if($d->id != $oneway_data->b_pk_id){?> <a href="javascript:;" class='btn yellow' onclick="book_package(<?php echo $d->id ?>)" ><i class="fa fa-cab"></i></a><?php } ?></td>
										   ...
										   <div class="col-md-4">
                                             <label class="control-label">Select Agent<span class="required">*</span></label>
											  ...
											  <select class="form-control select2" name="agent_name" id="agent_id" data-placeholder="Choose a Category" tabindex="1" required>
																	   ...
																	   <option value="<?php echo $ad->id; ?>"><?php echo $ad->a_full_name; ?></option>
																	   <?php } ?>
                                       ...
                                       <!--/span-->
                                         <div class="col-md-12">
										  ...
										  <div class="col-md-4">
                                             ...
                                             <input class="form-control"  type="text"  name="driver_contact" id="driver_number_id"  required/>
                                          </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $passanger_data->p_full_name;?>" disabled >
									   ...
									   <div class="col-md-4">
                                          <div class="form-group">
                                            ...
                                            <input type="text" id="firstName" class="form-control" value="<?php echo $passanger_data->p_contact;?>" disabled >
...
function invoice_generate(id)
{
	...
	$.ajax({
		...
		type: "POST",
		data: {edit:id,balnce:balnce,Last_city:lcity,pay_type:pay_type,total_amount:total_amount,tax_value:tax_value,tax_percentage:tax_percentage,tax_name:tax_name,tax_type:tax_type,ticket_id:ticket_id,pay_amount:pay_amount},
		success: function(resp)
		{
			//alert(resp);	
...
{	
	...
	//	alert(id+"    "+cancel_type+"    "+cancel_time+"  "+cancel_date);
		...
		type: 'post',
		data: {id:id,cancel_time:cancel_time,cancel_date:cancel_date,cancel_type:cancel_type},
...
function book_package(package_id)
{
	var booking_id = <?php echo $oneway_data->id;?>;
		...
		type: 'post',
		data: {package_id : package_id, booking_id:booking_id },
		success: function(msg)
		{
					window.location.reload(1);
		}
...
function assign_cab()
{
	...
	$.ajax({
		...
		type: 'post',
		data: {id:id,cat_id:cat_id,agent_id:agent_id,vehicle_id:vehicle_id,driver_id:driver_id,driver_number_id:driver_number_id,vehicle_number:vehicle_number},
		success: function(msg)
		{					
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCvakIz-hxfrsBDtU4VxD2Sgk3l8oWXGxo&libraries=places" async defer></script>
