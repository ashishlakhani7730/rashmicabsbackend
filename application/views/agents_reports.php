                        ...
                        <div class="col-md-12">
                         	<div class="portlet light bordered">
                            	...
                            	<div class="portlet-body form">
                                	<!-- BEGIN FORM-->
                                	<form action="<?php echo base_url();?>index.php/Report_management/AgentsReports" id="subscribeForm" method="post" class="horizontal-form">
                                    	<div class="form-body">
											...
											<div class="row">
												...
												<div class="col-md-4">
                                               		<div class="form-group">
                                                        ...
                                                        <select name="agents" id="agents" class="form-control select2" required>
															<?php $agent_detail=$this->db->get('agent_detail')->result(); ?>
															<option value="0" selected="selected">All</option>
															<?php foreach($agent_detail as $row){ ?>
																<option value="<?php echo $row->id; ?>"><?php echo $row->a_full_name." - ".$row->a_contact_no1; ?></option>		      
                                           					<?php }?>
                                        				</select>
