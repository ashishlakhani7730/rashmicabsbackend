<?php $this->load->view('header');?>
                ...
                <div class="page-content">
                 ...
                 <div class="row">
                     ...
                     <div class="table-toolbar">
                  	 ...
                  	 <?php if($multicity_data->b_status < 4){?>

				  <?php if($multicity_data->b_status != 0){?>
                    ...
                    <?php if($multicity_data->b_status < 5 ){?>
                        ...
                        <div class="btn-group">
                           ...
                           <?php if($multicity_data->b_status ==4 ){?>Change Cab<?php } else { ?>Assign Cab<?php } ?>
						...
						<?php if($multicity_data->b_rent_card_status == 0){?>
					...
					<?php } ?>
						   ...
						   <form method="post" action="<?php echo base_url();?>index.php/Invoice_rent_card/view_rent_card">
							...
							<button type="submit" id="sample_editable_1_new" name="view_id" value="<?php echo $multicity_data->id;?>" class="btn btn yellow-haze" >
						  ...
						  <?php if($multicity_data->b_status ==4 && $multicity_data->b_rent_card_id !=0 && $multicity_data->b_rent_card_status == 1){?>
						...
						<?php }?>
						  ...
						  <?php if($multicity_data->b_status >=5 && $generate_invoice['balance'] > 0){?>
                     ...
                     <?php }?>
					  ...
					  <?php if($multicity_data->b_status ==6 ){?>
 ...
 <hr>
				  ...
				  <table class="table table-bordered">
                           ...
                           <thead>
                              ...
                              <tr >
                                 ...
                                 <th colspan="5" class="blue_row">Booking Details</th>
                                  ...
                                  <th colspan="2" class="blue_row"> <form method="post">
                           ...
                           <tbody>
                              ...
                              <tr >
									 ...
									 <td><?php echo $multicity_data->b_id;?></td>

									 <td><?php echo date('d/m/Y h:i A',strtotime($multicity_data->b_booking_date_time));?></td>

									 <td><?php echo date('d/m/Y',strtotime($multicity_data->b_from_date))." ".date('h:i A',strtotime($multicity_data->b_from_time));?></td>

									 <td><?php echo $this->db->get_where('city_detail',array('id'=>$multicity_data->b_from_city))->row()->c_name; ?></td>

									 <td><?php echo $multicity_data->b_pickup_point;?></td>

									 <td><?php echo $multicity_data->b_drop_point;?></td>

									<td>

									<?php if($multicity_data->b_status == 0){echo "<span class='label label-sm label-danger'>Cancelled</span>";} if($multicity_data->b_status == 1){echo "<span class='label label-sm label-info'> pending </span>";} if($multicity_data->b_status == 2){echo "<span class='label label-sm label-primary'>Owner Assigned </span>";}  if($multicity_data->b_status == 3){echo " <span class='label label-sm label-default'> Driver Assigned </span>";} if($multicity_data->b_status == 4){ if($multicity_data->b_rent_card_id !=0 && $multicity_data->b_rent_card_status == 1){ echo "<span class='label label-sm label-default'> Duty Slip Generated </span>"; } else { echo "<span class='label label-sm label-warning'> Cab Assigned </span>"; } } if($multicity_data->b_status == 5){ if( $generate_invoice['balance'] > 0 ){echo "<span class='label label-sm label-info'> Complete Trip</span>";}else{ echo "<span class='label label-sm label-info'> Due  </span>"; }  } if($multicity_data->b_status == 6){ if( $generate_invoice['balance'] > 0 ){echo "<span class='label label-sm label-info'> Due </span>";}else{echo "<span class='label label-sm label-success'> Trip Finished</span>"; } }?>
                              ...
                              <tr>
								 <!--<?php //if($multicity_data->b_ac_non_ac == 1) { ?>AC<?php //} else {?>NON-AC <?php //} ?>-->
                                  <td><?php echo $this->db->get_where('vehicle_category_detail',array('id'=>$multicity_data->b_vc_id))->row()->category_name; ?> </td>

                                  <td><?php echo $this->db->get_where('vehicle_detail',array('v_category_id'=>$multicity_data->b_vc_id))->row()->v_name; ?></td>

								  <td>RS. <?php echo $multicity_data->b_pk_rate;?></td>

                                  <td>Rs. <?php echo $multicity_data->b_pk_rate_per_km;?></td>

                                  <td>Rs. <?php echo $multicity_data->b_pk_rate_per_hour;?></td>

                                  <td><?php echo $multicity_data->b_pk_min_km; ?></td>

                                  <td><?php echo $multicity_data->b_pk_min_hour; ?></td>
                           ...
                           <thead>
                              ...
                              <tr>
                                 ...
                                 <td colspan="2"><?php echo $multicity_data->b_p_name; ?></td>

                                 <td><?php echo $multicity_data->b_p_contact; ?></td>                              

                                 <td><?php echo $this->db->get_where('payment_type',array('id'=>$multicity_data->b_payment_type))->row()->payment_name;?></td>

                                 <td  colspan="3">Package ID : <?php echo $multicity_data->b_package_id; ?> , 

								 <?php echo $multicity_data->package_type." ".$multicity_data->package_sub_type;?> , 

								

								 Vahicle Category : <?php echo $multicity_data->category_name;?> , 

								 City : <?php echo $multicity_data->c_name;?>
                              ...
                              <tr>
                                  ...
                                  <td colspan="2"><?php if($multicity_data->b_updated_by!=0){ echo $this->db->get_where('user_detail',array('id'=>$multicity_data->b_updated_by))->row()->u_full_name." - "; echo date('d/m/Y h:i A',strtotime($multicity_data->b_updated_date_time)); } else { echo "N/A";   } ?></td>                               

								  <td colspan="2" ><?php if($multicity_data->b_cancelled_by!=0){ echo $this->db->get_where('user_detail',array('id'=>$multicity_data->b_cancelled_by))->row()->u_full_name." - ";  echo date('d/m/Y h:i A',strtotime($multicity_data->b_cancel_date_time)); } else { echo "N/A"; }?></td>

								                                

                                  <td colspan="2"><?php if($multicity_data->b_cancelled_by!=0){ if($multicity_data->b_cancel_type==1){echo "Customer";} if($multicity_data->b_cancel_type==2){echo "Agent";}  if($multicity_data->b_cancel_type==3){echo "Rashmi Cabs";}}else { echo "N/A"; }?></td	>   

								  

								  <td colspan="2"><?php if($multicity_data->b_cancelled_by!=0){echo $multicity_data->b_cancel_note;}else { echo "N/A"; }?></td	>                                                 
							   ...
							   <?php if($multicity_data->b_status!=1) {?>

							  <?php if($multicity_data->b_status!=0 || $multicity_data->b_status==4) {?>
                              ...
                              <tr>
										 ...
										 <td colspan="1"><?php echo $this->db->get_where('agent_detail',array('id'=>$multicity_data->b_agent_id))->row()->a_full_name;?></td>

										 

										 <td colspan="2"><?php if(!empty($multicity_data->b_vc_category_id)){echo $this->db->get_where('vehicle_category_detail',array('id'=>$multicity_data->b_vc_category_id))->row()->category_name;}?><br /><?php if(!empty($multicity_data->b_vehicle_id)){echo $this->db->get_where('vehicle_detail',array('id'=>$multicity_data->b_vehicle_id))->row()->v_name;}?></td>

										 

										 <td><?php echo $multicity_data->b_driver_name; ?></td>

										 

										 <td><?php echo $multicity_data->b_driver_contact; ?></td> 

										 

										 <td><?php echo $multicity_data->b_vehicle_number; ?></td>

										  

										 <td colspan="1"><?php if($multicity_data->b_cab_assign_type==1){echo "By Agent - ".$this->db->get_where('agent_detail',array('id'=>$multicity_data->b_cab_assign_by))->row()->a_full_name." - ";}else{echo $this->db->get_where('user_detail',array('id'=>$multicity_data->b_cab_assign_by))->row()->u_full_name." - ";} ?><?php echo date('d/m/Y h:i A',strtotime($multicity_data->b_assign_date_time)); ?></td>
							  ...
							  <?php if($multicity_data->b_complain_msg!=''){?>
                              ...
                              <tr>
                                  ...
                                  <td colspan="4"><?php if($multicity_data->b_complain_msg!=''){ echo $multicity_data->b_complain_msg; } else { echo "N/A";   } ?></td>                               

								  <td colspan="2" ><?php if($multicity_data->b_complain_datetime!='0000-00-00 00:00:00'){ echo date('d/m/Y h:i A',strtotime($multicity_data->b_complain_datetime)); } else { echo "N/A"; }?></td>

								                                

                                  <td colspan="2"><?php if($multicity_data->b_complain_read_datetime!='0000-00-00 00:00:00'){ echo date('d/m/Y h:i A',strtotime($multicity_data->b_complain_read_datetime)); } else { echo "N/A"; }?></td	>   
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title"><strong>Multicity Booking Edit</strong></h4>
					...
					<div class="modal-body">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="name" name="b_p_name" value="<?php echo $multicity_data->b_p_name;?>" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="mobile" name="b_p_contact" value="<?php echo $multicity_data->b_p_contact;?>"  >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="pickup" name="b_pickup_point" value="<?php echo $multicity_data->b_pickup_point;?>" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="drop" name="b_drop_point" value="<?php echo $multicity_data->b_drop_point;?>">
							...
							<div class="row">
													...
													* </span>
													...
													<div>
														...
														<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
															...
															<input type="text"  name="b_from_date" id="b_from_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($multicity_data->b_from_date));?>" readonly >
													...
													* </span>
													...
													<div>
														...
														<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
															...
															<input type="text"  name="b_to_date" id="b_to_date" class="form-control" value="<?php echo date('d-m-Y',strtotime($multicity_data->b_to_date));?>" readonly >
								...
								<div class="form-group col-md-4">
									...
									<input type="text" id="time" name="b_from_time" class="form-control timepicker timepicker-no-seconds" style="width: 200px" value="<?php echo $multicity_data->b_from_time;?>" required>

									<input type="hidden" id="Editid" value="<?php echo $multicity_data->id?>">
	...
	<div class="modal fade bs-modal-lg" id="modify_packages" tabindex="-1" role="dialog" aria-hidden="true">
		...
		$data =$this->db->get_where('package_detail',array('p_sub_type'=>$multicity_data->b_type,'p_from_city'=>$multicity_data->b_from_city))->result();		

		

		

		$total_distance_km = $multicity_data->b_estimated_distance;
		...
		{			
				...
				$date = new DateTime($multicity_data->b_from_time);
...

				{
					...
					$night_charge_status=0;
						...
						$date1 = date_create(date('Y-m-d',strtotime($multicity_data->b_from_date)));

						$date2 = date_create(date('Y-m-d',strtotime($multicity_data->b_to_date)));
				...
				$total_estimated_rate =  $km_rate ;
...

				  {
					 ...
					 $total_advance_rate =  ($d->p_advance_type * $total_estimated_rate)/100;
		...
		<tr class="odd gradeX" >
				...
				<td><?php echo $this->db->get_where('vehicle_category_detail',array('id'=>$d->p_v_category))->row()->category_name; ?> <br></td>
				...
				<td><?php echo 'Rs. '.$total_estimated_rate; ?></td>

				

				<td ><?php if($d->id != $multicity_data->b_pk_id){?> <a href="javascript:;" class='btn yellow' onclick="book_package(<?php echo $d->id ?>,<?php echo $total_estimated_rate; ?>)" ><i class="fa fa-cab"></i></a><?php } ?></td>
		...
		<?php
			...
			?>
							...
							<div class="modal fade bs-modal-lg" id="cancelBooking" tabindex="-1" role="dialog" aria-hidden="true">
								...
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-content">
										...
										<form action="<?php echo base_url();?>index.php/Multicity_view/cancel_booking" method="post" class="horizontal-form">

											

											<input type="hidden" name="id" value="<?php echo $multicity_data->id;?>"  />
                                       ...
                                       <!--/span-->
                                         ...
                                         <!--<div class="col-md-6">
                                             ...
                                             <input class="form-control form-control  date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php //echo date('d-m-Y',strtotime($multicity_data->b_booking_date_time));?>"   size="16" type="text"  name="cancel_date" id="cancel_date" />
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn red-haze" onclick="cancel(<?php echo $multicity_data->id;?>)" >Cancel Booking</button>
								...
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<input type="hidden" name="id" id="id" value="<?php echo $multicity_data->id;?>"  />
                                          ...
                                          <div class="form-group">
										   ...
										   <div class="col-md-4">
                                             ...
                                             <label class="control-label">Select Agent<span class="required">*</span></label>
											  ...
											  <select class="form-control select2" name="agent_name" id="agent_id" data-placeholder="Choose a Category" tabindex="1" required>

											  							<option></option>

                                                                       <?php foreach($agent_data as $ad){?>

																	   <option value="<?php echo $ad->id; ?>" <?php if($ad->id==$multicity_data->b_agent_id){?> selected="selected"<?php }?>><?php echo $ad->a_full_name." - ".$ad->a_city; ?></option>
								...
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-content">
										...
										<div class="modal-header">
											...
											<h4 class="modal-title">Duty Slip</h4>
							...
							<input type="hidden" name="view_id" id="view_id" value="<?php echo $multicity_data->id; ?>"/>			 
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4">
										  ...
										  <?php ?>
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $multicity_data->b_vehicle_number;?> - <?php echo $this->db->get_where('vehicle_detail',array('id'=>$multicity_data->b_vehicle_id))->row()->v_name;?>" disabled  >
                                       ...
                                       <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $this->db->get_where('agent_detail',array('id'=>$multicity_data->b_agent_id))->row()->a_full_name;?>" disabled placeholder="used Owner Name" >
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php echo $multicity_data->b_driver_name;?>" disabled >
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" id="firstName" class="form-control" value="<?php if($multicity_data->b_self_travel_status == 1){ echo $multicity_data->b_p_name; } else { echo $multicity_data->b_p_name." / ".$passanger_data->p_full_name; }?>" disabled >
									   ...
									   <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" id="firstName" class="form-control" value="<?php if($multicity_data->b_self_travel_status == 1){ echo $multicity_data->b_p_contact; } else { echo $multicity_data->b_p_contact." / ".$passanger_data->p_contact; }?>" disabled >
                                       ...
                                       <!--/span-->
									     ...
									     <div class="row">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" id="firstName" class="form-control" value="<?php echo $multicity_data->package_type." ".$multicity_data->package_sub_type;?>" disabled >
									   ...
									   <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" id="firstName" class="form-control" value="<?php echo $multicity_data->c_name; ?> - <?php echo $multicity_data->b_to_city; ?>" disabled>
									   ...
									   <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                             ...
                                             <label class="control-label">Date of Journey<span class="required">*</span></label>
                                       					   ...
                                       					   <input class="form-control " size="16" type="text" name="start_date"  onfocus="check_time()" id="start_date" value="<?php echo date('d-m-Y',strtotime($multicity_data->b_from_date));?>" readonly/>
									   ...
									   <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                             ...
                                             <label class="control-label">Date of Return</label>
                                          					...
                                          					<input class="form-control form-control date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php echo date('d-m-Y',strtotime($multicity_data->b_from_date));?>" size="16" type="text"  name="return_date" id="return_date" onfocus="check_time()" />
                                       ...
                                       <!--/span-->
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="form-group ">
                                           ...
                                           <input type="text" class="form-control " name="start_time" id="start_time" value="<?php echo date('h:i A',strtotime($multicity_data->b_from_time));?>" readonly >
								...
								<div class="row">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="service_code" class="form-control" readonly placeholder="used service code" value="<?php echo $multicity_data->b_package_id; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="firstName" class="form-control" readonly placeholder="used service name" value="<?php echo $multicity_data->package_type." - ".$multicity_data->package_sub_type;?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="base_price" class="form-control" readonly value="<?php  echo $multicity_data->b_pk_rate; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="calculated_min_km" class="form-control" readonly value="<?php  echo $multicity_data->b_pk_min_km * $total_days; ?>">

											<input type="hidden" id="min_km" class="form-control" readonly value="<?php  echo $multicity_data->b_pk_min_km  ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="trip_start_date" class="form-control" readonly value="<?php  echo date('d/m/Y h:i A',strtotime($multicity_data->b_from_date." ".$multicity_data->b_from_time)); ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input type="text" id="advance_pay" class="form-control" readonly value="<?php  echo $multicity_data->b_advance; ?>">
									...
									<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="driver_invoice" class="form-control" value="<?php  echo $multicity_data->b_pk_driver_allowance; ?>" readonly>
									...
									<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="night_charge" class="form-control" value="<?php if($multicity_data->b_night_charge_status==1) {echo $multicity_data->b_pk_night_charge;}else {echo "0";} ?>" readonly>
                                    ...
                                    <div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="drop_night_charge" class="form-control" value="<?php if($multicity_data->b_drop_night_charge_status==1) {echo $multicity_data->b_drop_night_charge;}else {echo "0";} ?>" readonly>
									...
									<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<label class="control-label">Discount</label>&nbsp;<span class="badge badge-success"><?php if($multicity_data->b_pk_discount_type==0){

													echo $multicity_data->b_pk_discount_type."%";
...
<?php
											...
											if($multicity_data->b_pk_discount_type==0){

												echo $multicity_data->b_pk_discount;
									...
									<!--<div class="col-md-4">
										...
										<div class="form-group ">
											...
											<input type="text" id="descri_invoice" class="form-control" value="">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn green" onClick="update_invoice(<?php echo $multicity_data->id; ?>)">Complete Trip</button>
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<input type="text" id="firstName" class="form-control" readonly placeholder="used service name" value="<?php

										

										echo $generate_invoice['type'].'-'.$generate_invoice['sub_type']; ?>">
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										...
										<input type="text" id="firstName" class="form-control" readonly value="<?php  echo $generate_invoice['min_km'] * $total_days; ?>">
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										...
										<input type="text" id="firstName" class="form-control" readonly value="<?php  echo $generate_invoice['min_hr']; ?>">
								...
								<div class="col-md-2">
									...
									<div class="form-group">
										...
										<input type="text" id="exatra_hr_invoice1" class="form-control" value="<?php echo $generate_invoice['extra_hr']; ?>" readonly>
...
<?php echo $generate_invoice['discount'];	?>"  readonly="readonly">
								...
								<div class="col-md-4">
									...
									<div class="form-group ">
										...
										$c=$this->db->get_where('city_detail',array('id'=>$multicity_data->b_from_city))->row();
										...
										echo $c->c_name;
													...
													if($multicity_data->b_type == '2')

													{

														$to_city = $this->db->get_where('city_detail',array('id'=>$multicity_data->b_to_city))->row();
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-success" onClick="invoice_generate(<?php echo $multicity_data->id;?>)">Generate Invoice</button>
	...
	$('#cat_id').on('change', function()			  

	 {
		...
		{   
			...
			url: "<?php echo base_url();?>index.php/Multicity_view/get_city_by_state", 
...
function get_vehicle_category_data(){
		...
		var vehicle_id = '<?php echo $multicity_data->b_vehicle_id; ?>';
...
function get_vehicle_data(){
	...
	var cat_id = '<?php echo $multicity_data->b_vc_category_id; ?>';
...
function get_driver_data(){
	...
	var assign_driver_id = <?php echo $multicity_data->b_assign_driver_id; ?>;
...
{	
	...
	$.ajax({
		...
		url: '<?php echo base_url(); ?>index.php/Multicity_view/generate_invoice',
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url()."index.php/Multicity_view/update_booking"; ?>',
...

{
		...
		var booking_id = <?php echo $multicity_data->id?>;

		

		$.ajax({

		url: '<?php echo base_url(); ?>index.php/Multicity_view/modify_booking_package',

		type: 'post',

		data: {package_id : package_id, booking_id:booking_id, total_estimated_rate:total_estimated_rate },
...

{
		...
		url: '<?php echo base_url(); ?>index.php/Multicity_view/cancel_booking',
		...
		data: {id:id,cancel_time:cancel_time,cancel_date:cancel_date,cancel_type:cancel_type,cancel_note:cancel_note},
...

			{
						...
						var form = $('<form action="<?php echo base_url(); ?>index.php/Multicity_view" method="post">' +

					  '<input type="hidden" name="multicity_view_id" value="' + id + '"></input>' + '</form>');
...

{
	...
	$.ajax({
		...
		url: '<?php echo base_url(); ?>index.php/Multicity_view/assign_cab',
...
var view_id= <?php echo $multicity_data->id?>;

$('#return_time').val('');

$.ajax({

	url: '<?php echo base_url(); ?>index.php/Multicity_view/fetch_rent_card',
