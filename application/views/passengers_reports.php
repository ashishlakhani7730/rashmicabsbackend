                        ...
                        <div class="col-md-12">
                         	<div class="portlet light bordered">
                            	...
                            	<div class="portlet-body form">
                                	<!-- BEGIN FORM-->
                                	<form action="<?php echo base_url();?>index.php/Report_management/PassengersReports" id="subscribeForm" method="post" class="horizontal-form">
                                    	<div class="form-body">
											...
											<div class="row">
												...
												<div class="col-md-4">
                                               		<div class="form-group">
                                                    	<label class="control-label">Passengers</label><span class="required">*</span>
                                                        <select name="passenger_id" id="passenger_id" class="form-control select2" required>
															<?php $passenger_list=$this->db->get('passenger_list')->result(); ?>
															<option value="0" selected="selected">All</option>
															<?php foreach($passenger_list as $row){ ?>
																<option value="<?php echo $row->id; ?>"><?php echo $row->p_full_name." - ".$row->p_contact; ?></option>		      
                                           					<?php }?>
                                        				</select>
