                          	...
                          	<div class="portlet light bordered">
						  		<div class="note note-danger" id="validation_message" style="display:none;"> <p>  </p> </div>
                                	...
                                	<div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo base_url();?>index.php/Agent_vehicle_management/insert_agent_vehicle" method="post" enctype="multipart/form-data" class="horizontal-form">
											<div class="form-body">
												<div class="row">
															 ...
															 <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="control-label">Insurance Expiry Date</label><span class="required">*</span>
                                                                      <input class="form-control form-control  date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d"  size="16" type="text" name="v_insurance_expire_date" id="v_insurance_expire_date" required >
                                                             ...
                                                             <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="control-label">Vehicle Register No.</label><span class="required">*</span>
                                                                      <input type="text"  name="v_register_no" id="v_register_no" class="form-control" required >
