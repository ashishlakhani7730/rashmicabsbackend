...
<?php $this->load->view('header'); ?>
        ...
        <?php if($invoice->type=="LOCAL" || $invoice->sub_type=="ONEWAY") {?>										

            

                <button formaction="<?php echo base_url();?>index.php/Local_view" type="submit" class="btn yellow-haze" value="<?php echo $booking_details->id;?>" name="local_view_id">Booking View <i class="fa fa-eye"></i></button>
        ...
        <?php } ?>
          ...
          <td style="padding-left:5px;"> 
		  <button formaction="<?php echo base_url();?>index.php/Invoice_view/invoice_view_local_ex" type="submit" class="btn purple" value="<?php echo $invoice->id;?>" name="ticket_id"> Duplicate </button>
									...
									<table width="100%" border="1" >
	 									...
	 									<tr bgcolor="#CCCCCC" style="color:#000; font-size:16px; font-weight:700">
	  									...
	  									<tr>
											...
											<td width="25%" style="color:#000; font-size:14px; font-weight:700">MINIMUM KM (<?php echo $min_km = $invoice->min_km; echo "  Km"; ?>)</td>

											<td width="25%" style="color:#000; font-size:14px; font-weight:700" align="right"><?php  $min_km_rate = $invoice->base_price;  echo number_format($invoice->base_price);	?></td>
	  	 								...
	  	 								<tr bgcolor="#EEEEEE">
											...
											<td width="25%" style="color:#000; font-size:14px; font-weight:700">EXTRA KM <?php $extra_km = $invoice->extra_km - $min_km;?> (<?php echo $extra_km." x ".$invoice->rate_per_km; ?>)</td>
										...
										<tr bgcolor="#EEEEEE">
											...
											<td width="25%" style="color:#000; font-size:14px; font-weight:700" align="right"><?php $driver_allow = $invoice->driver_allowance=0; echo "N/A";?></td>
