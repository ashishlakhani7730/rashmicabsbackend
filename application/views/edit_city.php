...
<?php $this->load->view('header');?>
            ...
            <div class="container-fluid">
                <div class="page-content">
                    ...
                    <div class="breadcrumbs">
                        <h1>Edit City (Use For Services Provides)</h1>
                        ...
                        <div class="col-md-12">
                          <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url();?>index.php/City_management/update_city" method="post" class="horizontal-form">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">City Name</label><span class="required">*</span>
                                                                      <input type="text" name="city_name" id="city_id" class="form-control" value="<?php echo $edit_city_data->c_name; ?>" required>
                                           ...
                                           <option value="<?php echo $edit_city_data->c_state; ?>" selected="selected" ><?php echo $edit_city_data->c_state; ?></option>
        ...
        <option value="<?php echo $count->state; ?>"><?php echo $count->state; ?>
                                                             ...
                                                             <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">Lattitude</label>
                                                                      <input type="text" value="<?php echo $edit_city_data->c_lattitude; ?>"  name="lattitude" id="lattitude" class="form-control"  >
															  ...
															  <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label">Longitude</label><span class="required">*</span>
                                                                      <input type="text" id="longitude" name="longitude" class="form-control" value="<?php echo $edit_city_data->c_longitude;?>">
                                                    ...
                                                    <div class="form-actions right">
                                                        ...
                                                        <button type="submit" name="city_update_id" value="<?php echo $edit_city_data->id; ?>" class="btn yellow">
                                                            <i class="fa fa-check"></i>Update City</button>
                                                    </div>
                                                </form>
                                                <!-- END FORM-->
                                            </div>
...
<?php
	if($edit_city_data->c_lattitude != "")
	{
		 $lat = $edit_city_data->c_lattitude;
	}
	else
	{
		 $lat = "22.3071588";
	...
	if($edit_city_data->c_longitude != "")
	{
		 $long = $edit_city_data->c_longitude;
	}
	else
	{
		 $long = "73.18121870000004";
	}
?>
