                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane active" id="tab1">
                                                                    ...
                                                                    <div class="form-group">
                                                                       ...
                                                                       <input type="text" name="b_to_city" id="to_city_id" class="placepicker form-control" placeholder="Enter a location" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                      <input class="form-control form-control-inline date-picker" size="16" type="text" id="from_date" data-date-format="dd-mm-yyyy" data-date-start-date="+0d" value="" required>                     </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                      <input class="form-control form-control-inline date-picker" size="16" type="text" id="to_date" data-date-format="dd-mm-yyyy" data-date-start-date="+0d" value="" required>                     </div>
                                                                    </div>
                                                                    <div class="form-group">
                                          ...
                                          <input type="checkbox" id="self_travel" name="self_travel" value="1">Self Travel </span>
                                                                    ...
                                                                    <input type="text" name="b_drop_point" id="drop_point" class="form-control" required>
                                                                      ...
                                                                      <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                    <input type="text" name="advance_rate" id="advance_rate" class="form-control" required>
                                                                    </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-actions">
                                                            <div class="row">
                                                                <div class="col-md-offset-3 col-md-9">
                                                                    ...
                                                                    <a href="javascript:;" onclick="return confirm_roundtrip_booking();" class="btn green button-submit"> Submit
...
{	
	 $( "#advance_rate" ).change(function() 
	 {
		 var fix_adv = $('#hiden_advance').val();
		 var advance = $('#advance_rate').val()
...
function add_passenger()
{
		...
		{
				$.ajax({
					url: '<?php echo base_url(); ?>index.php/Roundtrip_booking/add_passenger',
					type: "POST",
...
function book_package(package_id,advance_rate,total_distance,chargeable_km,total_days,total_estimated_rate)
{
			...
			$('#drop_point').val($('#to_city_id').val());
			
		
		
			$.ajax({
			url: '<?php echo base_url(); ?>index.php/Roundtrip_booking/selected_package_detail',
			type: 'post',
			...
			success: function(msg)
			{
				...
				$('#advance_rate').val(Math.round(advance_rate));
				$('#hiden_advance').val($('#advance_rate').val());
...
function get_package()
{
	...
	var to_city = $('#to_city_id').val();
	var from_date = $('#from_date').val();
	var to_date = $('#to_date').val();
	var start_time = $('#start_time').val();
	var b_to_city = $("input[name='b_to_city']").map(function(){ return $(this).val();}).get().join(" - ");	
	
	//alert(from_city);alert(b_to_city);
	
	
		$.ajax({
			url: '<?php echo base_url(); ?>index.php/Roundtrip_booking/get_package_data',
			type: 'post',
			data: {from_city:from_city,to_city:to_city,from_date:from_date,to_date:to_date,start_time:start_time,b_to_city:b_to_city},
			success: function(msg)
			{
				//	alert(msg);		
					$('#package_data').empty();
...
function confirm_roundtrip_booking()
{
	//alert('found');
	var package_id = $('#package_id').val();
	var b_from_city = $('#b_from_city').val();
	var b_from_date = $('#from_date').val();
	var b_from_time = $('#start_time').val();
	var b_to_date = $('#to_date').val();
	...
	var b_advance = $('#advance_rate').val();
	var b_night_charge_status = $('#night_charge_status').val();
	var b_to_city = $("input[name='b_to_city']").map(function(){ return $(this).val();}).get().join(" - ");
	var b_to_city_id = $('#to_city_id').val();
	...
	$.ajax({
			url: '<?php echo base_url(); ?>index.php/Roundtrip_booking/confirm_outstation_booking',
			type: 'post',
