                        ...
                        <div class="col-md-12">
                          <div class="portlet light bordered">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form id="subscribeForm" action="<?php echo base_url();?>index.php/Package_management/insert_package" method="post" class="horizontal-form">
                                                    <div class="form-body">
                                                            ...
                                                            <!--/span-->
                                                             <div class="col-md-3">
                                                                <div class="form-group">
																	...
																	foreach($city_registered_list as $cr)
																	{
																		if($cr->p_from_city == $c->id)
																		{
																			$available="disabled";
																		}
																	}
																	?>
																		...
																		<option value="<?php echo $c->id?>"  <?php echo $available; ?>><?php echo $c->c_name;?></option>                                                      
                                                        <?php }?>     
                                            </optgroup>
                                        </select>
                                         ...
                                         <div class="input-inline input-medium">
                                                            ...
                                                            <div class="input-group">
															 ...
															 <?php if($edit_package->p_discount_type==1) { ?>
                                                                ...
                                                                <span class="input-group-addon"><input type="checkbox" id="discount_id" name="discount_name" value="1" checked></span>
                                      				 ...
                                      				 <div class="input-inline input-medium">
                                                            ...
                                                            <div class="input-group">
															 ...
															 <?php if($edit_package->p_discount_type==1) { ?>															 
																...
																<input type="checkbox" value="1" id="package_id" name="package_name" checked></span>
