...
<?php $this->load->view('header'); ?>
         ...
         <!-- END PAGE HEADER-->
			...
			<tr style="background:#CCC; color:#000; font-weight:500;">
                        ...
                        <tr>
                           <td colspan="2">MINIMUM KM    (<?php $tot_km = $invoice->min_km * $invoice->total_days;
							   echo number_format($tot_km)." x ".$invoice->rate_per_km; ?>)</td>
                           <td align="right"><?php $min_km_rate = ($invoice->min_km * $invoice->total_days) * $invoice->rate_per_km; echo number_format($min_km_rate);	?></td>
                        </tr>
						...
						<tr>						  
                           ...
                           <td colspan="2" >EXTRA KM <?php $extra_km = $invoice->extra_km - $tot_km;?> (<?php echo $extra_km." x ".$invoice->rate_per_km; ?>)</td>
					...
					<?php }  }?>  
						 ...
						 <tr>
                           ...
                           <td  align="right" style="background:#CCC; color:#000; font-weight:bold;"> <?php  $tax_value = explode(',',$invoice->tax_value);
							...
							$fare_amount =  $min_km_rate + $extra_km_rate - $invoice->discount	+ $i;
			...
			<tr style="background:#CCC; color:#000; font-weight:500;">
                         ...
                         <tr>
							   ...
							   <td align="right"><?php  $driver_allow = $invoice->driver_allowance * $invoice->total_days; echo number_format($driver_allow); ?></td>		
								<?php } else { ?>
							   <td align="right"><?php $invoice->driver_allowance=0; echo $driver_allow="N/A";?></td>		
								<?php } ?>
                        ...
                        <tr>						  
                           <td colspan="2">DROP NIGHT CHARGE</td>
								...
								<?php if($invoice->drop_night_charge == 0) {?>
						...
						<tr>
						  ...
						  <?php }
							...
							{?>
								   <td colspan="2">BORDER TAX</td>
								   <td align="right"><?php echo 'N/A'; $border_tax = $invoice->border_tax = 0 ; ?></td>			   						<?php } ?>
						...
						<tr> 
						 ...
						 <tr>
                           ...
                           <td  align="right" style="background:#CCC; color:#000; font-weight:bold;">
                               <?php $other_charges = $drop_night_charge + $driver_allow + $toll_charge + $parking_charge + $border_tax + $night_charge + $other_charge; echo number_format($other_charges);?></td>
                        </tr>
             ...
             <div class="col-xs-6" align="right">
                ...
                <table class="table table-toolbar" border="0" >
