...
<?php $this->load->view('header'); ?>
        ...
        <?php } ?>
          ...
          <td style="padding-left:5px;">
		<button formaction="<?php echo base_url();?>index.php/Invoice_view/outstation_invoice_without" type="submit" class="btn purple" value="<?php echo $invoice->id;?>" name="ticket_id"> Duplicate </button>
