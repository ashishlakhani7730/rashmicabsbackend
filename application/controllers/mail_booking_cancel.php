...
$subject = 'EzeeTaxi Cabs ';
 $message_mail =  "<html><head><title>For Email Verification</title>
		...
		<tr>
			<td align='center' valign='top'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='0' class='mobile-shell'>
							...
							<table bgcolor='#fff' width='100%' border='0' cellspacing='0' cellpadding='0'>
								<tr>
									...
									<td>
										...
										<div class='img-center' style='font-size:0pt; line-height:0pt; text-align:center'><a href='#' target='_blank'><img src='".base_url()."assets/mailimg/logo.png' border='0' width='203px' height='auto' alt='' /></a></div>
										<table width='100%' border='0' cellspacing='0' cellpadding='0' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'><tr><td height='30' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'>&nbsp;</td></tr></table>
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														<tr>
															...
															<td>
																...
																<div class='h4-center' style='color:#1e1e1e; font-family: Varela Round, sans-serif; min-width:auto !important; font-size:16px; line-height:22px; text-align:justify'>
					<p>We would like to thank you for choosing eZee TAXI, please find below the details of your booking cancellation:</p>
					<p>
					 <table class='table table-bordered margin-top-10' border='0' style='font-size:12px;' width='100%'   >
                        ...
                        <tbody >
                           ...
                           <tr bgcolor='#EFEFEF'>
                              ...
                              <td  align='right'>".$vehicle_category->vc_name."</td>           
                          </tr>  
						   <tr >
                              <td >Trip Type</td>
                           ...
                           <tr bgcolor='#EFEFEF'>
						    ...
						    <tr >
                              <td >Cancellation</td>
                              <td  align='right'>".$refund_time."</td>           
                          </tr>  
						  
                           <tr bgcolor='#EFEFEF'>
                              <td >Eligible Refund Amount</td>
                              <td  align='right'>Rs. ".$advance_return."</td>           
                          </tr> 
						    <tr >
                              <td >Refund Process Time</td>
                              <td  align='right'>7 Business Days</td>           
                          </tr>   
					...
					For any refund queries please email us on <a href='mailto:accounts@eZeeTAXI.com' target='_blank'>accounts@eZeeTAXI.com</a>
					</p>											
																</div>
													...
													<div class='fluid-img' style='font-size:0pt; line-height:0pt; text-align:center; background:#F7E6B4'><a href='#' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/ezeesail.png' border='0' width='400' height='auto' alt='ezeetaxi' /></a></div>
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														<tr>
															<td class='content-spacing' style='font-size:0pt; line-height:0pt; text-align:left' width='20'></td>
															<td>
																...
																<div style='color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:14px; line-height:22px; text-align:left'>
																	...
																	<tr>
																		<td align='center'>
																			<table border='0' cellspacing='0' cellpadding='0'>
																				<tr>
																					<td class='img-center' style='font-size:0pt; line-height:0pt; text-align:center' width='38'><a href='https://www.facebook.com/ezeetaxi/' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/ico_facebook.jpg' border='0' width='28' height='28' alt='ezeetaxi' /></a></td>
																					<td class='img-center' style='font-size:0pt; line-height:0pt; text-align:center' width='38'><a href='https://twitter.com/ezeetaxi' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/ico_twitter.jpg' border='0' width='28' height='28' alt='ezeetaxi' /></a></td>
																					<td class='img-center' style='font-size:0pt; line-height:0pt; text-align:center' width='38'><a href='https://plus.google.com/u/0/118007799914118656174' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/g_plus.png' border='0' width='28' height='28' alt='ezeetaxi' /></a></td>
																					<td class='img-center' style='font-size:0pt; line-height:0pt; text-align:center' width='38'><a href='https://www.youtube.com/channel/UCu9dI9bKWCJyfCRf-1p_ctw' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/y_tube.png' border='0' width='28' height='28' alt='ezeetaxi' /></a></td>
																				</tr>
																			</table>
																		</td>
																	</tr>
				...
				<div class='wgmail' style='font-size:0pt; line-height:0pt; text-align:center'><img src='https://d1pgqke3goo8l6.cloudfront.net/oD2XPM6QQiajFKLdePkw_gmail_fix.gif' width='600' height='1' style='min-width:600px' alt='ezeetaxi' border='0' /></div>
			</td>
		</tr>
	</table>
</body>
