		...
		<tr>
			<td align='center' valign='top'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='0' class='mobile-shell'>
					...
					<p>We thank you for doing business with eZee TAXI, please find below the details of your trip:</p>
					<p>
					 <table class='table table-bordered margin-top-10' border='0' style='font-size:12px;' width='100%'   >
                        ...
                        <tbody >
						   ...
						   <tr >
                              ...
                              <td  align='right'>Rs.".$expense_detail->total_amount."</td>           
                          </tr> 
                         <tr >
                              <td >Balance Paid to Driver / Payable</td>
                              <td  align='right'>".$invoice_detail->total_amount."</td>           
                          </tr> 
					...
					For any queries or feedback email us on <a href='mailto:booking@eZeeTAXI.com' target='_blank'>booking@eZeeTAXI.com</a><br/><br/>
					Happy Partnering
					</p>											
																</div>
