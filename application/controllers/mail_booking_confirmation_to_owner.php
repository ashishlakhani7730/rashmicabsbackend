		...
		<tr>
			<td align='center' valign='top'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='0' class='mobile-shell'>
					...
					<p>We thank you for doing business with eZee TAXI, please find below the details of your accepted booking:</p>
					<p>
				...
				<br /><br />
				No modification will be accepted within 4 hours of the trip, and any refund to customer on account of any modification will be deducted from the amount payable in your account.
				<br/><br />
				Happy Partnering.
					</p>											
																</div>
