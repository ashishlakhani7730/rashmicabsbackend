		...
		<tr>
			<td align='center' valign='top'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='0' class='mobile-shell'>
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														<tr>
															...
															<td>
																...
																<div class='h3-1-center' style='color:#1e1e1e; font-family: Varela Round, sans-serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:justify'>Dear ".$owner_details->o_full_name.",
                                                                </div>
																<table width='100%' border='0' cellspacing='0' cellpadding='0' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'><tr><td height='15' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'></td></tr></table>
					...
					<p>We would like to thank you for doing business with eZee TAXI, please find below the details of your booking:</p>
					<p>
					 <table class='table table-bordered margin-top-10' border='0' style='font-size:12px;' width='100%'   >
                        ...
                        <tbody >
						   ...
						   <tr >
                              ...
                              <td  align='right'>".$booking_details->pk_min_km." KM</td>           
                          </tr> 
                           <tr bgcolor='#EFEFEF'>
                              <td >Pick up Point</td>
				...
				Please note, you will send us the driver and vehicle details prior to 5 hours of the pickup time by email and SMS or a call.
				
				<br />
				No Changes will be accepted within 4 hours of the trip, and any refund to customer will be deducted from the amount payable in your account.
					</p>											
																</div>
													...
													<div class='fluid-img' style='font-size:0pt; line-height:0pt; text-align:center; background:#F7E6B4'><a href='#' target='_blank'><img src='http://ezeetaxi.com/app/assets/mailimg/ezeesail.png' border='0' width='400' height='auto' alt='' /></a></div>
													<table width='100%' border='0' cellspacing='0' cellpadding='0'>
														<tr>
															<td class='content-spacing' style='font-size:0pt; line-height:0pt; text-align:left' width='20'></td>
															<td>
																...
																<div class='text-2' style='color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:14px; line-height:22px; text-align:left'>
																	Regard,<br /><strong>eZee Taxi Team</strong><br />+91 70 9696 3933 (eZee)<br />
																</div>
																<table width='100%' border='0' cellspacing='0' cellpadding='0' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'><tr><td height='35' class='spacer' style='font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%'>&nbsp;</td></tr></table>
