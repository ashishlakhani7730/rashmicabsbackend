		...
		<tr>
			<td align='center' valign='top'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='0' class='mobile-shell'>
					...
					<p>We would like to thank you for choosing eZee TAXI, please find below the details of your Driver and vehicle:</p>
					<p>
					 <table class='table table-bordered margin-top-10' border='0' style='font-size:12px;' width='100%'   >
                        ...
                        <tbody >
						   ...
						   <tr >
                              ...
                              <td  align='right'>".$vehicle_details->vt_name."</td>           
                          </tr> 
                           <tr bgcolor='#EFEFEF'>
                              <td >Plate Number</td>
                              <td  align='right'>".$vehicle_details->v_register_no."</td>           
                          </tr>  
						   <tr >
                              <td >Driver Name</td>
                              <td  align='right'>".$driver_details->d_full_name."</td>           
                          </tr> 
                           <tr bgcolor='#EFEFEF'>
                              <td >Driver Mobile Number</td>
                              <td  align='right'>".$driver_details->d_contact."</td>           
                          </tr>  
                                <tr bgcolor='#EFEFEF'>
                              <td ></td>
                              <td  align='right'><img src='http://ezeetaxi.com/app/uploads/driver/profile/".$driver_details->d_profile."' border='0' width='203px' height='auto' alt='ezeetaxi' ></img></td>           
                          </tr>     
					...
					For any queries please send us an email on <a href='mailto:Booking@eZeeTAXI.com' target='_blank'>Booking@eZeeTAXI.com</a><br/><br/>
